...
export default function FounderMessage() {
  const values = [
    { 
      ...
      // Flame Icon
      icon: (
        <svg className="w-6 h-6 text-[#A93226]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section className="bg-white py-24 px-6 md:px-12 lg:px-20" id="about">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative w-full max-w-md mx-auto lg:mx-0">
          ...
          <div className="relative h-[550px] w-full rounded-lg overflow-hidden shadow-2xl">
            {/* If using Next.js Image, swap this back in. Using img for broad compatibility */}
            <img 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-10">
            {values.map((v) => (
              <div key={v.title} className="flex flex-col items-start group">
                <div className="mb-3 p-3 bg-red-50 rounded-lg group-hover:bg-[#A93226] group-hover:text-white transition-colors duration-300">
                  {/* Notice how hovering changes the background, so we make the SVG inherit the text color */}
